...
export FASTVIDEO_TRUE_MONARCH_NUM_ITERS=1
export FASTVIDEO_TRUE_MONARCH_MIN_BLOCK_SIZE=2
...
training_args=(
  ...
  --wandb_run_name wan_1.3b_t2v_true_monarch_attn_1_iter
  --output_dir "checkpoints/wan_1.3b_t2v_true_monarch_attn_1_iter"
