...
export FASTVIDEO_MONARCH_USE_DYNAMIC=1
...
training_args=(
  ...
  --wandb_run_name wan_1.3b_t2v_monarch_dynamic_max_constrain
  --output_dir "checkpoints/wan_1.3b_t2v_finetune_monarch_dynamic_max_constrain"
